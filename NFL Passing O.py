...
def scrape_nfl_rushing_stats(year):
    ...
    for row in team_rows:
        ...
        if len(team_stats) == 16:
            # Match with correct headers
            headers = ["Team", "Att", "Cmp", "Cmp %", "Yds/Att", "Pass Yds", "TD", "INT", "Rate", "1st", "1st%", "20+", "40+", "Lng", "Sck", "SckY"]
...
headers = ["Year", "Team", "Att", "Cmp", "Cmp %", "Yds/Att", "Pass Yds", "TD", "INT", "Rate", "1st", "1st%", "20+", "40+", "Lng", "Sck", "SckY"]
...
# Save to Excel
df.to_excel('nfl_passing_stats.xlsx', index=False)

print("Scraping complete. Data saved to nfl_passing_stats.xlsx.")
